...
<script type="text/javascript">
    ...
    Ext.onReady(function() {
    	var barcodeproduct = new bo.MenuPanel({
            id:'barcodeproduct',
            title:'条码打印',
            childs:[{
                    text: '按采购单打印条码',
                    iconCls:'icon-barcode',
                    url:'${ctx}/barcodepurchase.do'
                },
                {
                    text: '按产品打印条码',
                    iconCls:'icon-barcode',
                    url:'${ctx}/barcodeproduct.do'
                },
                {
                    text: '按顾客订单打印条码',
                    iconCls:'icon-barcode',
                    url:'${ctx}/barcodeorder.do'
                }
            ]
        });
        
        var barcodeList = new bo.MenuPanel({
	        title:'查询',
	        childs:[
	            {
	                text: '条码打印查询',
	                iconCls:'icon-cart',
	                url:'${ctx}/barcodequery.do'
	            }
